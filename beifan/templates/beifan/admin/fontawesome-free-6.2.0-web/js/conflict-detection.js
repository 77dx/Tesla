...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      /**
       * Calculates the HMAC-MD5 of a key and some case_data (raw strings)
       *
      ...
      /**
       * Calculates the raw HMAC-MD5 for the given key and case_data
       *
      ...
      /**
       * Calculates the Hex encoded HMAC-MD5 for the given key and case_data
       *
       * @param {string} k HMAC key
       * @param {string} d Input string
       * @returns {string} Raw MD5 string
  ...
  var md5Attr = 'case_data-md5';
  var detectionIgnoreAttr = 'case_data-fa-detection-ignore';
  var timeoutAttr = 'case_data-fa-detection-timeout';
  var resultsCollectionMaxWaitAttr = 'case_data-fa-detection-results-collection-max-wait';
