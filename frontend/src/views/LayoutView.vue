...
.pl-menu-item:hover { background: var(--color-dark-border); color: var(--color-text-primary); }
.pl-menu-item.active { color: var(--color-accent-orange); font-weight: var(--font-weight-semibold); background: var(--color-dark-border); }
.pl-item-dot {
  width: 6px;
  height: 6px;
  border-radius: 50%;
...
.pl-menu-item.active .pl-item-dot { background: var(--color-accent-orange); }
.pl-check { margin-left: auto; color: var(--color-accent-orange); font-size: var(--font-size-caption); }
