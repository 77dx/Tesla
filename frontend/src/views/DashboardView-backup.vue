...
.welcome-card {
  ...
  align-items: center;
  padding: var(--space-4xl) var(--space-5xl);  /* 增加内边距 */
...
.section-title {
  ...
  margin: 0 0 var(--space-xl);  /* 从lg增加到xl */
  padding-bottom: var(--space-md);  /* 从sm增加到md */
...
.feature-card {
  ...
  gap: var(--space-xl);  /* 从lg增加到xl */
  padding: var(--space-3xl);  /* 从2xl增加到3xl */
  cursor: pointer;
...
.fc-name {
  ...
  line-height: var(--line-height-relaxed);  /* 从normal增加到relaxed */
}
...
.feature-card:hover .fc-arrow {
  color: var(--color-terracotta-brand);
  opacity: 1;
...
/* ===== 指南卡片 ===== */
.guide-card {
  padding: var(--space-4xl);  /* 从3xl增加到4xl */
  border-radius: var(--radius-very-rounded);
  background-color: var(--color-ivory);
  border: 1px solid var(--color-border-cream);
...
.guide-steps::before {
  ...
  height: 2px;
  background: linear-gradient(90deg,
    var(--color-border-warm) 0%,
    var(--color-border-cream) 100%);
  z-index: 0;
}
...
.step-num {
  ...
  align-items: center;
  justify-content: center;
  margin-bottom: var(--space-lg);  /* 从md增加到lg */
  flex-shrink: 0;
